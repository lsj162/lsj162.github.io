import{_ as s,c as i,o as a,a6 as n}from"./chunks/framework.DwCPU-X7.js";const o=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"工具箱/文档工具/vitepress/详细配置.md","filePath":"工具箱/文档工具/vitepress/详细配置.md","lastUpdated":null}'),l={name:"工具箱/文档工具/vitepress/详细配置.md"},p=n(`<h2 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h2><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">...</span></span>

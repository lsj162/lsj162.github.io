import{_ as a,c as s,o as n,a6 as p}from"./chunks/framework.DwCPU-X7.js";const b=JSON.parse('{"title":"词法语法","description":"","frontmatter":{},"headers":[],"relativePath":"前端/JavaScript/官方文档基础教程/基本语法/词法语法/index.md","filePath":"前端/JavaScript/官方文档基础教程/基本语法/词法语法/index.md","lastUpdated":1712030009000}'),e={name:"前端/JavaScript/官方文档基础教程/基本语法/词法语法/index.md"},l=p(`<h1 id="词法语法" tabindex="-1">词法语法 <a class="header-anchor" href="#词法语法" aria-label="Permalink to &quot;词法语法&quot;">​</a></h1><h2 id="基础" tabindex="-1">基础 <a class="header-anchor" href="#基础" aria-label="Permalink to &quot;基础&quot;">​</a></h2><p>JavaScript 是区分大小写的，并使用 Unicode 字符集。</p><p>在 JavaScript 中，指令被称为语句，并用分号（;）进行分隔。独占一行的话，那么分号是可以省略的。</p><h2 id="注释" tabindex="-1">注释 <a class="header-anchor" href="#注释" aria-label="Permalink to &quot;注释&quot;">​</a></h2><p>Javascript 注释的语法和 C++ 或许多其他语言类似：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 单行注释</span></span>

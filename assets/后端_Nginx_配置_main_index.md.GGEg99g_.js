import{_ as s,o as i,c as a,R as n}from"./chunks/framework.FQOLfzW2.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"后端/Nginx/配置/main/index.md","filePath":"后端/Nginx/配置/main/index.md"}'),p={name:"后端/Nginx/配置/main/index.md"},l=n(`<h2 id="main-上下文" tabindex="-1">main 上下文 <a class="header-anchor" href="#main-上下文" aria-label="Permalink to &quot;main 上下文&quot;">​</a></h2><p>nginx.conf 配置文件，如果块指令可以在大括号内包含其他指令，则称为上下文（例如： events、 http、 server 和 location）。</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># nginx进程,一般设置为和cpu核数一样</span></span>

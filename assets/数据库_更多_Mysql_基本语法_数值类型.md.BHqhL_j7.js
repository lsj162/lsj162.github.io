import{_ as s,c as a,o as n,a5 as t}from"./chunks/framework.DALfHeHd.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"数据库/更多/Mysql/基本语法/数值类型.md","filePath":"数据库/更多/Mysql/基本语法/数值类型.md","lastUpdated":1716891854000}'),p={name:"数据库/更多/Mysql/基本语法/数值类型.md"},e=t(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>类型            大小            范围（有符号）          范围（无符号）          用途</span></span>
...
<span class="line"><span>浮点数值</span></span>
<span class="line"><span>DECIMAL	对DECIMAL(M,D) ，如果M&gt;D，为M+2否则为D+2	依赖于M和D的值	依赖于M和D的值	小数值</span></span></code></pre></div>`,1),l=[e];function c(i,_,o,d,r,E){return n(),a("div",null,l)}const I=s(p,[["render",c]]);export{h as __pageData,I as default};

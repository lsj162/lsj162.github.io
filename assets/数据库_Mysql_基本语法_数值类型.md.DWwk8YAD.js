import{_ as s,c as a,o as n,a5 as t}from"./chunks/framework.-E9IboRH.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"数据库/Mysql/基本语法/数值类型.md","filePath":"数据库/Mysql/基本语法/数值类型.md"}'),p={name:"数据库/Mysql/基本语法/数值类型.md"},e=t(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>类型            大小            范围（有符号）          范围（无符号）          用途</span></span>

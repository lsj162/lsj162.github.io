import{_ as a,c as s,o as n,a5 as p}from"./chunks/framework.-E9IboRH.js";const g=JSON.parse('{"title":"伪类","description":"","frontmatter":{},"headers":[],"relativePath":"前端/CSS/备份/伪类/index.md","filePath":"前端/CSS/备份/伪类/index.md"}'),e={name:"前端/CSS/备份/伪类/index.md"},l=p(`<h1 id="伪类" tabindex="-1">伪类 <a class="header-anchor" href="#伪类" aria-label="Permalink to &quot;伪类&quot;">​</a></h1><p>CSS 伪类是添加到选择器的关键字，用于指定所选元素的特殊状态。</p><h2 id="常见的伪类" tabindex="-1">常见的伪类： <a class="header-anchor" href="#常见的伪类" aria-label="Permalink to &quot;常见的伪类：&quot;">​</a></h2><h3 id="链接" tabindex="-1">链接 <a class="header-anchor" href="#链接" aria-label="Permalink to &quot;链接&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>a:link {</span></span>
...
<span class="line"><span>该关系伪类表示与任何一个与锚定的元素的相对选择器相匹配（如果有的话）的元素。</span></span></code></pre></div>`,18),i=[l];function t(c,o,d,h,r,u){return n(),s("div",null,i)}const v=a(e,[["render",t]]);export{g as __pageData,v as default};

...
<span class="line"><span>该关系伪类表示与任何一个与锚定的元素的相对选择器相匹配（如果有的话）的元素。</span></span></code></pre></div>`,20),i=[l];function t(c,o,d,h,r,u){return n(),s("div",null,i)}const v=a(e,[["render",t]]);export{g as __pageData,v as default};
